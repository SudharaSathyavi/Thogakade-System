...
public class PlaceOrderFormController {
    ...
    private void setItemData(String id) throws SQLException, ClassNotFoundException {
         ...
         txtUnitPrice.setText(String.valueOf(temp.getUnitPrice()));
    ...
    private void loadItemCodes() throws SQLException, ClassNotFoundException {
       ObservableList<String> oblist = FXCollections.observableArrayList(new ItemController().getAllItemCodes());
